      ...
      endpoints: [
        {
          ...
          description: 'command: "balance" — return the current player balance',
          pathLink: '/seamless-wallet/balance',
        },
        {
          method: 'POST',
          path: '{operatorCallbackURL}',
          description: 'command: "bet" — deduct a bet from the player balance',
          pathLink: '/seamless-wallet/bet',
        },
        {
          method: 'POST',
          path: '{operatorCallbackURL}',
          description: 'command: "win" — credit a win to the player balance',
          pathLink: '/seamless-wallet/win',
        },
        {
          method: 'POST',
          path: '{operatorCallbackURL}',
          description: 'command: "cancel" — refund a failed or reversed bet',
